...
public class playerArrowIce_5 : MonoBehaviour {
	private const int NUM_ROWS = 7;
	private const int NUM_COLS = 7;
	public iceBlock_5[] ices;
	...
	void Start () {
		...
		squares_explored_ice_list.Add ("62");
		squares_explored_ice_list.Add ("66");
	...
	public void reset() {
		...
		transform.position = new Vector3(-4.5f,-8,0);
		square = new Vector2(7,2);
	...
	private bool victory() {
		foreach(iceBlock_5 i in ices) {
			if(coordinatesToSquare(i.square).Equals ("44")) {
				victorious = true;
				return true;
			} 
		}
	...
	private void push(iceBlock_5 ice) {
