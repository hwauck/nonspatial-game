...
public class playerArrowIce_2 : MonoBehaviour {
	private const int NUM_ROWS = 7;
	private const int NUM_COLS = 7;
	public iceBlock_2[] ices;
	...
	private bool victory() {
		foreach(iceBlock_2 i in ices) {
			if(coordinatesToSquare(i.square).Equals ("42")) {
				victorious = true;
				return true;
			} 
		}
	...
	private void push(iceBlock_2 ice) {
