...
public class playerArrowIce_3 : MonoBehaviour {
	private const int NUM_ROWS = 7;
	private const int NUM_COLS = 8;
	public iceBlock_3[] ices;
	...
	void Start () {
		...
		square = new Vector2(7,2);
		predictedSquare = new Vector2(7,3); //player faces right to start
		...
		squares_explored_player_list.Add ("72");

		squares_explored_ice_list = new List<string>();
		squares_explored_ice_list.Add ("42");
		squares_explored_ice_list.Add ("53");
		squares_explored_ice_list.Add ("67");
		...
		bottom_squares_list.Add ("67");
		bottom_squares_list.Add ("68");
		bottom_squares_list.Add ("71");
		bottom_squares_list.Add ("72");
		bottom_squares_list.Add ("73");
		bottom_squares_list.Add ("74");
		bottom_squares_list.Add ("75");
		bottom_squares_list.Add ("76");
		bottom_squares_list.Add ("77");
		bottom_squares_list.Add ("78");
	...
	public void reset() {
		...
		square = new Vector2(7,2);
		predictedSquare = new Vector2(7,3);
		direction = Vector3.right;
		prevMoveDir = direction;
		transform.rotation = Quaternion.Euler(right);
	...
	private bool victory() {
		foreach(iceBlock_3 i in ices) {
			if(coordinatesToSquare(i.square).Equals ("45")) {
				foreach(iceBlock_3 j in ices) {
					if(coordinatesToSquare(j.square).Equals ("42")){
						victorious = true;
						return true;
					}
				}
	...
	private void push(iceBlock_3 ice) {
